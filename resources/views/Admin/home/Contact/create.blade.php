            ...
            <form action="{{ route('Contact.store') }}" method="POST" class="form-group">
                ...
                <div class="row gy-5">
                    <x-form-column>  
                        ...
                        <input type="url" name="FCC_em" class="form-control" id="FCC_em" placeholder="Email here...">
                    </x-form-column>
                    <x-form-column>
                        <label for="FCC_su" class="form-label fs-5">Label 1 Detials</label>
                        <input type="url" name="FCC_su" class="form-control" id="FCC_su" placeholder="your@email.com">
                    </x-form-column>
                    <x-form-column>
                        <label for="FCC_of" class="form-label fs-5">Label of Contact Type 2</label>
                        <input type="url" name="FCC_of" class="form-control" id="FCC_of" placeholder="Enter Location here...">
                    </x-form-column>
                    <x-form-column>
                        <label for="FCC_ad" class="form-label fs-5">Label 2 Details</label>
                        <input type="url" name="FCC_ad" class="form-control" id="FCC_ad" placeholder="13, St. Park Street">
                    </x-form-column>
                    <x-form-column>
                        <label for="FCC_ph" class="form-label fs-5">Label of Contact Type 3</label>
                        <input type="url" name="FCC_ph" class="form-control" id="FCC_ph" placeholder="Telephone">
                    </x-form-column>
                    <x-form-column>
                        <label for="FCC_nu" class="form-label fs-5">Label 3 Details</label>
                        <input type="url" name="FCC_nu" class="form-control" id="FCC_nu" placeholder="+012-345-6789">
                    </x-form-column>
